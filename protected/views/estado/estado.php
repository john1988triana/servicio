...
$this->menu=array(
	array('label'=>'Administrador Orden de Servicios', 'url'=>array('ordenservicio/adminn')),
);
?>
...
<!-- 	<tr>
	...
	<tr>
		<td class="span5"><strong style="font-size:14px"><?php echo CHtml::encode($modelultimo->getAttributeLabel('estado')); ?></strong></td>
		<td class="span7"><?php echo CHtml::encode($modelultimo->estado); ?></td>
	</tr>
	<tr>
		<td class="span5"><strong style="font-size:14px"><?php echo CHtml::encode($modelultimo->getAttributeLabel('descripcion')); ?></strong></td>
	...
	<tr>
		<td class="span5"><strong style="font-size:14px"><?php echo CHtml::encode($modelultimo->getAttributeLabel('fecha_estado')); ?></strong></td>
		<td class="span7"><p id="fechainicio" style="margin:0px 0px 0px"><?php echo CHtml::encode($modelultimo->fecha_estado); ?></p></td>
	</tr>
	<tr id="colores">
		<td class="span5"><strong style="font-size:14px"><?php echo CHtml::encode("Tiempo Transcurrido"); ?></strong></td>
